...
namespace ACT.Core.Attributes.SystemCore
{
    ...
    public class ACT_Application_Information : Attribute
    {
        ...
        [JsonProperty("act_systemcore_filetype", NullValueHandling = NullValueHandling.Ignore)]
        public ACT_SystemCore_FileType FileType { get; set; }
